...
if __name__ == "__main__":
    ...
    source_path = f'C:\\Users\\Prave\\Downloads\\stud_data\\baumer_2_resize'
    dest_path = source_path +"_aug/"
    # "blend":blend,"rotate_90":rotate_90,"rotate_180":rotate_180,
    # 'rotate':rotate,'flip_hr':flip_hr,'flip_vr':flip_vr,'affine':move,'contrast':contrast,'resize':resize,'crop':crop,
    #             'brightness':brightness , "drop":dro'
    augment_list = ["brightness","flip_hr","flip_vr","affine","contrast","resize","drop"]#["affine","drop","brightness","flip_hr","flip_vr","contrast","resize","rotate_180"]#"brightness","flip_hr","flip_vr","contrast","resize","rotate_90","rotate_180"]#,"brightness" ,'flip_hr','flip_vr','resize'"drop","noise","affine","rotate"
