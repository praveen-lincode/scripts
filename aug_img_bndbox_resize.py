...
source_path = 'D:\\lincode\\leather\\chopped'
dest_path = source_path +"_aug/"

augment_list = ["rotate_90","contrast","flip_vr"]#'rotate','flip_hr','flip_vr',,'resize''crop',"drop"
...
#resize
resize = iaa.Resize({"height": 3072, "width": 2048})#"height": 480, "width": 640
#crop
...
if __name__ == "__main__":
    ...
    source_path = f'D:/lincode/magna/ATV/training_data/batch_9_mosaic'
    dest_path = source_path +"_aug/"
    # "blend":blend,"rotate_90":rotate_90,"rotate_180":rotate_180,
    # 'rotate':rotate,'flip_hr':flip_hr,'flip_vr':flip_vr,'affine':move,'contrast':contrast,'resize':resize,'crop':crop,
    #             'brightness':brightness , "drop":dro'
    augment_list = ["resize"]#["affine","drop","brightness","flip_hr","flip_vr","contrast","resize","rotate_180"]#"brightness","flip_hr","flip_vr","contrast","resize","rotate_90","rotate_180"]#,"brightness" ,'flip_hr','flip_vr','resize'"drop","noise","affine","rotate"
